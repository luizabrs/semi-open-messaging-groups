...
class DLEQProof : public IZKProof
{
    private:
    static const size_t salt_BYTES = crypto_hash_sha256_BYTES;
    static const size_t commitment_BYTES = 2 * crypto_core_ristretto255_BYTES;
    public:
    static const size_t witness_BYTES = crypto_core_ristretto255_SCALARBYTES; // w
    static const size_t statement_BYTES = 4 * crypto_core_ristretto255_BYTES; // (g, a, g^w, a^w)
